 ...
 * @param {string} footerComponent: Component to be displayed below the HCaptcha
 * @param {string} topComponent: Component to be displayed above the HCaptcha
 */
const Hcaptcha = ({
  onMessage,
  size,
  ...
  const debugInfo = useMemo(() => {
    ...
    try {
      ...
      result.push(
        "sdk_" + hcaptchaPackage.version.toString().replace(/\./g, "_")
      );
    } catch (e) {
      console.log(e);
    } finally {
    ...
    () =>
      ...
      <head>
        ...
        <script type="text/javascript">
          ${JSON.stringify(
            debugInfo
          )}.forEach(function (value, i) { window[value] = true; });
        </script>
